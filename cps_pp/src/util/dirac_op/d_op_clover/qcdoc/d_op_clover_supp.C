...
//  $Header: /space/cvs/cps/cps++/src/util/dirac_op/d_op_clover/qcdoc/d_op_clover_supp.C,v 1.4 2004/08/18 11:57:49 zs Exp $
//  $Id: d_op_clover_supp.C,v 1.4 2004/08/18 11:57:49 zs Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: d_op_clover_supp.C,v $
//  $Revision: 1.4 $
//  $Source: /space/cvs/cps/cps++/src/util/dirac_op/d_op_clover/qcdoc/d_op_clover_supp.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
