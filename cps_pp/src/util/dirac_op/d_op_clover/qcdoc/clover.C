...
//  $Header: /space/cvs/cps/cps++/src/util/dirac_op/d_op_clover/qcdoc/clover.C,v 1.7 2008/09/22 15:35:08 chulwoo Exp $
//  $Id: clover.C,v 1.7 2008/09/22 15:35:08 chulwoo Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: clover.C,v $
//  $Revision: 1.7 $
//  $Source: /space/cvs/cps/cps++/src/util/dirac_op/d_op_clover/qcdoc/clover.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
