...
//  $Header: /space/cvs/cps/cps++/src/util/parallel_transport/pt_base/qmp/pt_vvpd.C,v 1.4 2011/02/26 00:19:27 chulwoo Exp $
//  $Id: pt_vvpd.C,v 1.4 2011/02/26 00:19:27 chulwoo Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: pt_vvpd.C,v $
//  $Revision: 1.4 $
//  $Source: /space/cvs/cps/cps++/src/util/parallel_transport/pt_base/qmp/pt_vvpd.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
